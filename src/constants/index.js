...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Developing and maintaining web applications using html,google script  and google sheet  related technologies.",
      "Collaborating with cross-functional teams including designers, product managers, and other developers to create high-quality products.",
      "Implementing responsive design and ensuring cross-browser compatibility.",
    ],
  },
...
const projects = [
  {
    name: "lazim Hostel",
    description:
      "A web-based platform that enables users to look for, reserve, and manage hostel accommodations offers a practical and effective solution for hostel demands.",
    tags: [
      {
        name: "react",
